...
if SPY_AVAILABLE and spy is not None:
    try:
        ...
        import os
        max_req = int(os.environ.get('SPY_MAX_CONCURRENT_REQUESTS', '4'))
...
def authenticate_seeq(url: str, access_key: str, password: str, 
    ...
    try:
        ...
        # Fallback: if per-session didn't set user, try global user
        if current_user is None:
            try:
                ...
                current_user = getattr(spy, 'user', None)
            except Exception:
                current_user = None
...
def search_sensors_only(sensor_names: list, url: str = None, access_key: str = None, 
    ...
    try:
        ...
        if url and access_key and password:
            ...
            auth_result = authenticate_seeq(url, access_key, password, auth_provider, ignore_ssl_errors, session_obj=None)
...
def seeq_search():
    ...
    try:
        ...
        result = search_sensors_only(sensor_names, seeq_url, username, password, auth_provider, ignore_ssl_errors, session_obj=None)
...
def seeq_data():
    ...
    try:
        ...
        result = search_and_pull_sensors(sensor_names, start_time, end_time, grid, None, user_timezone, seeq_url, username, password, auth_provider, ignore_ssl_errors, session_obj=None)
...
def search_sensors_excel():
    ...
    try:
        ...
        # Use SPy to search for sensors
        result = search_sensors_only(sensor_names, url, access_key, password, auth_provider, ignore_ssl_errors, session_obj=None)
...
def sensor_data_excel():
    ...
    try:
        ...
        result = search_and_pull_sensors(sensor_names, start_datetime, end_datetime, grid, None, user_timezone, url, access_key, password, auth_provider, ignore_ssl_errors, session_obj=None)
